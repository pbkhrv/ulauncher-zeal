EXT_PKG=zeal
EXT_DIR=com.github.pbkhrv.ulauncher-zeal
...
run:
	VERBOSE=1 ULAUNCHER_WS_API=ws://127.0.0.1:5054/com.github.pbkhrv.ulauncher-zeal PYTHONPATH=/usr/lib/python3/dist-packages /usr/bin/python3 `pwd`/main.py
